...
{
	public class AdditiveNetworkSyncedPlayerStat<T> : NumericPlayerStatBase<T>, INetworkSyncedPlayerStat,
		INetworkStatStorage<T> where T : struct, IComparable, IComparable<T>, IEquatable<T>, IConvertible, IFormattable
	{
		...
		public AdditiveNetworkSyncedPlayerStat(T default_valueAdditive, in Func<T, T, T> addFunc,
			in Func<T, T, T> substractFunc, string formatting = "N0")
		{
