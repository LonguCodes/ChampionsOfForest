...
{
	public class MultiplicativeNetworkSyncedPlayerStat<T> : NumericPlayerStatBase<T>, INetworkSyncedPlayerStat,
		INetworkStatStorage<T> where T : struct, IComparable, IComparable<T>, IEquatable<T>, IConvertible, IFormattable
	{
		...
		public MultiplicativeNetworkSyncedPlayerStat(T default_valueMultiplicative, in Func<T, T, T> multFunc,
			in Func<T, T, T> divideFunc, string formatting = "N0")
		{
		...
		public void RecievedOtherPlayerChange(byte[] data)
		{
