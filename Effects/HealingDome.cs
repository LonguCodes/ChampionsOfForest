...
namespace ChampionsOfForest.Effects
{
	public class HealingDome : MonoBehaviour
	{
		...
		public static void CastFromData(HealingDomeData data)
		{
			CreateHealingDome(data.Pos, data.Radius, data.Healing, data.GrantImmunity, data.RegenEnergy, data.Duration);
		}

		public static void CreateHealingDome(Vector3 pos, float radius, float healing, bool grantImmunity,
			bool regensenergy, float duration)
		{
			if (material == null)
			{
