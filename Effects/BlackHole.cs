...
namespace ChampionsOfForest
{
	public class BlackHole : MonoBehaviour
	{
		...
		public static void CastFromData(BlackHoleData data)
		{
			CreateBlackHole(data.Pos, data.FromEnemy, data.Damage, data.Duration, data.Radius, data.PullForce, data.SparksOfLightAfterDarknessPlayerId);
		}
